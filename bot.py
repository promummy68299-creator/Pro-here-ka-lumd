...
BOT_TOKEN = "8912326354:AAH8pef6Ni13Gfb8Xnepzf4h3bZwr9L-aVM"
...
PAYTM_ENV = "TEST"
PAYTM_CALLBACK_URL = "https://your-bot.railway.app/paytm-callback"
...
def handle_cb(call):
    global AUTO_PAYMENT, MANUAL_PAYMENT  # <-- FIX: Global declaration at top
    ...
    try:
        ...
        # ========== PAYMENT SETTINGS ==========
            ...
            if is_admin(user_id):
                ...
                AUTO_PAYMENT = new_val  # <-- Global update
            ...
            if is_admin(user_id):
                ...
                MANUAL_PAYMENT = new_val  # <-- Global update
