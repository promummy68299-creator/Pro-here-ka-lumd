...
def payment_settings_keyboard():
    ...
    kb.add(
        ...
        types.InlineKeyboardButton("🔗 Callback URL", callback_data="ps_callback")
    )
    kb.add(types.InlineKeyboardButton("🔙 Back", callback_data="admin_panel"))
    return kb
...
def handle_cb(call):
    ...
    try:
        ...
        # ========== PAYTM PAYMENT ==========
            ...
            merchant_key = db.get_setting('paytm_merchant_key')
            callback_url = db.get_setting('paytm_callback_url')
        ...
        # ========== PAYMENT SETTINGS ==========
            ...
            if is_admin(user_id):
                ...
                callback = db.get_setting('paytm_callback_url') or 'Not set'
        ...
        elif data == "ps_callback":
            if is_admin(user_id):
                user_data[user_id] = {'payment_setting': 'paytm_callback_url'}
                safe_edit(call.message.chat.id, call.message.message_id,
                         "🔗 Send Callback URL:\n\nExample: https://your-bot.railway.app/paytm-callback",
                         reply_markup=types.InlineKeyboardMarkup().add(
                         types.InlineKeyboardButton("🔙 Cancel", callback_data="admin_payment_settings")))
